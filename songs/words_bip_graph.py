...
if __name__ == "__main__":
    ...
    singer_list = [
        ...
        'sunyanzi', 'remen', 'fangwenshan', 'chenxinhong', 'caiyilin', 'wubai', 'zhoushen', 'zhoushen_pure', 'fenghuangchuanqi', 'wanglihong', 'beyond', 'wuyuetian', 'dengziqi', 'luodayou', 'taozhe', 'lizongsheng', 'mowenwei', 'fangdatong', 'wangsulong', 'maobuyi', 'suyoupeng', 'zhoujielun', 'liangjingru', 'liudehua', 'zhangshaohan', 'xuezhiqian'
    ]
